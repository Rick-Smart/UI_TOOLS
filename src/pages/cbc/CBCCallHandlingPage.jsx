...
const AGENT_NAME_KEY = "azdes.cbc.callHandling.agentName";
...
const ASK_QUESTION_MODAL_TITLE_ID = "cbc-ask-question-modal-title";
      ...
      >
        <div className="ask-question-form">
          {ASK_QUESTION_FIELDS.map((field, index) => {
            const inputId = `cbc-ask-question-${field.key}`;
